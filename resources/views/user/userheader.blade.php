            ...
            <nav class="navbar navbar-expand-lg bg-light  py-3 py-lg-0 pl-3 pl-lg-5">
                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <a href="/u/viewpanchayath" class="nav-item nav-link">VIEW PANCHAYATH</a>
                        <a href="/schemesandcertificate" class="nav-item nav-link active">SCHEMES AND CERTIFICATES</a>
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">view status</a>
                            <div class="dropdown-menu rounded-0 m-0">
                                <a href="/viewusercertificate" class="dropdown-item">Certificates</a>
                                <a href="/userviewschemes" class="dropdown-item">Schemes</a>
                            </div>
                        </div>
